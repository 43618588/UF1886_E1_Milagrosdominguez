...
| Entorno | Odoo | PostgreSQL | Apache Hop |
| --- | --- | --- | --- |
| DEV | Odoo Server 18.0-20251222 | postgres (PostgreSQL) 16.11 | apache/hop:2.17.0 |
| QA | Odoo Server 18.0-20251222 | postgres (PostgreSQL) 16.11 | apache/hop:2.17.0 |
| PROD | Odoo Server 18.0-20251222 | postgres (PostgreSQL) 16.11 | apache/hop:2.17.0 |

---

## observaciones

- Odoo y PostygreSQL están alineados en los tres entornos (misma versión).
